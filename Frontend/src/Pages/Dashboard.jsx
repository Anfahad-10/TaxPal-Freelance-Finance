...
const Dashboard = () => {
    ...
    // 2. Show a loading screen while fetching data
    if (loading) {
        return (
            <div className="min-h-screen bg- flex items-center justify-center text-white">
                <div className="w-10 h-10 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div>
            </div>
        );
    }

    // If user fails to load for some reason, don't crash
    if (!user) return null;
            ...
            <aside className="w-64 h-screen glass-sidebar fixed left-0 top-0 z-50 flex-col justify-between hidden md:flex">
                <div>
                    ...
                    <nav className="mt-8 px-4 space-y-2">
                        <a className="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-white font-medium transition-all group" href="#">
                            <span className="material-symbols-outlined text-blue-400 group-hover:text-blue-300">dashboard</span>
                            Dashboard
                        </a>
                        <a className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-slate-400 hover:text-white font-medium transition-all group" href="#">
                            <span className="material-symbols-outlined group-hover:text-purple-400 transition-colors">receipt_long</span>
                            Transactions
                        </a>
                        <a className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-slate-400 hover:text-white font-medium transition-all group" href="#">
                            <span className="material-symbols-outlined group-hover:text-emerald-400 transition-colors">pie_chart</span>
                            Budgets
                        </a>
                        <a className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-slate-400 hover:text-white font-medium transition-all group" href="#">
                            <span className="material-symbols-outlined group-hover:text-orange-400 transition-colors">calculate</span>
                            Tax Estimator
                        </a>
                    </nav>
                </div>
